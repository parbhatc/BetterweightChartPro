...
export function defaultChartOptions() {
  return {
    ...
    layout: {
      ...
      panes: { separatorColor: "#27272A", separatorHoverColor: "#3F3F46", enableResize: false },
    ...
    crosshair: {
      ...
      vertLine: { color: "#71717A", width: 1, style: LineStyle.LargeDashed, visible: true, labelVisible: true, labelBackgroundColor: "#18181B" },
      horzLine: { color: "#71717A", width: 1, style: LineStyle.LargeDashed, visible: true, labelVisible: true, labelBackgroundColor: "#18181B" },
    },
